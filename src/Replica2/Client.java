...
//            userID = sc.next().trim().toUpperCase();
    ...
    private static void startConcurrencyTest(NamingContextExt ncRef) throws Exception {
        ...
        ServerObjectInterface2 serverObjectInterface2 = ServerObjectInterface2Helper.narrow(ncRef.resolve_str("ATW"));
        //ServerObjectInterface2 servant = ServerObjectInterface2Helper.narrow(ncRef.resolve_str("ATW"));
        System.out.println("adding " + movieID + " " + movieName + " with capacity 2 to Atwater Server...");
        String response = serverObjectInterface2.addMovieSlot(movieID, movieName, 2);
        System.out.println(response);
        Runnable task1 = () -> {
            String customerID = "ATWC1234";
//            System.out.println("Connecting Montreal Server for " + customerID)

            String res = serverObjectInterface2.bookMovieTickets(customerID, movieID, movieName,numberOfTickets);
            System.out.println("Booking response for " + customerID + " " + res);
            res = serverObjectInterface2.cancelMovieTickets(customerID, movieID, movieName,numberOfTickets);
...
//            System.out.println("Connecting Montreal Server for " + customerID);
        ...
        Runnable task6 = () -> {
//            System.out.println("Connecting Montreal Server for " + customerID);
            String res = serverObjectInterface2.removeMovieSlots(movieID, movieName);
...
//        MovieManagementInterface remoteObject = (MovieManagementInterface) registry.lookup(Constant.MOVIE_MANAGEMENT_REGISTERED_NAME);
        ServerObjectInterface2 serverObjectInterface2 = ServerObjectInterface2Helper.narrow(ncRef.resolve_str(serverID));
        ...
        switch (menuSelection) {
            case Constant.CUSTOMER_BOOK_MOVIE:
            {
                ...
                serverResponse = serverObjectInterface2.bookMovieTickets(customerID, movieID, movieName, numberOfTickets);
            ...
            case Constant.CUSTOMER_CANCEL_MOVIE:
            {
                ...
                serverResponse = serverObjectInterface2.cancelMovieTickets(customerID, movieID, movieName, numberOfTickets);
                System.out.println(serverResponse);
            ...
            case Constant.CUSTOMER_GET_BOOKING_SCHEDULE:
            {
                ...
                serverResponse = serverObjectInterface2.getBookingSchedule(customerID);
            ...
            case Constant.CUSTOMER_EXCHANGE_TICKET:
            {
                ...
                serverResponse = serverObjectInterface2.exchangeTickets(customerID, newMovieID, movieName, movieID, numberOfTickets);
                System.out.println(serverResponse);
            ...
            case Constant.SHUTDOWN:
                ...
                serverObjectInterface2.shutdown();
...
//        MovieManagementInterface remoteObject = (MovieManagementInterface) registry.lookup(Constant.MOVIE_MANAGEMENT_REGISTERED_NAME);
        ...
        switch(menuSelection)
        {
            case Constant.ADMIN_ADD_MOVIE: {
                ...
                serverResponse = serverObjectInterface2.addMovieSlot(movieID,movieName,bookingCapacity);
                System.out.println(serverResponse);
            ...
            case Constant.ADMIN_REMOVE_MOVIE:
            {
                ...
                serverResponse = serverObjectInterface2.removeMovieSlots(movieID,movieName);
                System.out.println(serverResponse);
            ...
            case Constant.ADMIN_LIST_MOVIE_AVAILABILITY:{
                ...
                serverResponse = serverObjectInterface2.listMovieShowAvailability(movieName);
                System.out.println(serverResponse);
            ...
            case Constant.ADMIN_BOOK_MOVIE:{
                ...
                serverResponse = serverObjectInterface2.bookMovieTickets(adminID, movieID, movieName, bookingCapacity);
                System.out.println(serverResponse);
            ...
            case Constant.ADMIN_CANCEL_MOVIE:{
                ...
                serverResponse = serverObjectInterface2.cancelMovieTickets(adminID, movieID, movieName, bookingCapacity);
                System.out.println(serverResponse);
            ...
            case Constant.ADMIN_GET_BOOKING_SCHEDULE:{
                ...
                serverResponse = serverObjectInterface2.getBookingSchedule(adminID);
                System.out.println(serverResponse);
