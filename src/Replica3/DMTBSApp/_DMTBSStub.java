...
/**
* DMTBSApp/_DMTBSStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from DMTBSApp.idl
* Monday, April 10, 2023 9:29:09 o'clock PM EDT
*/

public class _DMTBSStub extends org.omg.CORBA.portable.ObjectImpl implements Replica3.DMTBSApp.DMTBS
{
  ...
  public String addMovieSlots (String movieID, String movieName, String[] bookingCapacity)
  {
            ...
            try {
                ...
                DMTBSApp.DMTBSPackage.listHelper.write ($out, bookingCapacity);
                $in = _invoke ($out);
  ...
  public String[] listMovieShowsAvailability (String movieName)
  {
            ...
            try {
                ...
                $out.write_string (movieName);
                $in = _invoke ($out);
                String $result[] = DMTBSApp.DMTBSPackage.listHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public String exchangeTickets (String customerID, String oldMovieID, String newMovieID, String newMovieName, int numberOfTickets)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return exchangeTickets (customerID, oldMovieID, newMovieID, newMovieName, numberOfTickets        );
            } finally {
                _releaseReply ($in);
            }
  } // exchangeTickets
