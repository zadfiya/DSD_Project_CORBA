...
/**
* Replica1.DMTBSapp/DMTBSPOA.java .
...
public abstract class DMTBSPOA extends org.omg.PortableServer.Servant
 implements Replica1.DMTBSapp.DMTBSOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  //First Start orbd follow Command :-  orbd -ORBInitialPort 1050
       case 0:  // Replica1.DMTBSapp/DMTBS/addMovieSlots
       {
       ...
       case 1:  // Replica1.DMTBSapp/DMTBS/removeMovieSlots
       {
         String movieID = in.read_string ();
         String movieName = in.read_string ();
         String $result = null;
       ...
       case 2:  // Replica1.DMTBSapp/DMTBS/listMovieShowsAvailability
       {
         String movieName = in.read_string ();
         String $result = null;
       ...
       case 3:  // Replica1.DMTBSapp/DMTBS/bookMovieTickets
       {
       ...
       case 4:  // Replica1.DMTBSapp/DMTBS/getBookingSchedule
       {
         String customerID = in.read_string ();
         String $result = null;
       ...
       case 5:  // Replica1.DMTBSapp/DMTBS/cancelMovieTickets
       {
         String customerID = in.read_string ();
         String movieID = in.read_string ();
         String movieName = in.read_string ();
       ...
       case 6:  // Replica1.DMTBSapp/DMTBS/exchangeTickets
       {
         String customerID = in.read_string ();
         String movieID = in.read_string ();
       ...
       case 7:  // Replica1.DMTBSapp/DMTBS/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
  ...
  private static String[] __ids = {
    "IDL:Replica1.DMTBSapp/DMTBS:1.0"};
